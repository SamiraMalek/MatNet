...
batch_in_epoch = 2000
batches_for_val = np.array([5,5,10,10,20,30,50,300])
...
with tf.Session() as sess:    
    ...
    X_test = np.load(folder_path+'/Saved_Model/Test_Data/x.npy')
    Y_test = np.load(folder_path+'/Saved_Model/Test_Data/y.npy')
