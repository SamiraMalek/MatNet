...
x_v = np.load(folder_path+'/LDPCMacKay_96_48/Saved_Model/TestData/x.npy') 
...
with tf.Session() as sess:    
    ...
    saver.restore(sess, folder_path+'/LDPCMacKay_96_48/Saved_Model/my_model')
    ...
    print('SNR[dB] validation - [1,2,3,4,5,6]')
