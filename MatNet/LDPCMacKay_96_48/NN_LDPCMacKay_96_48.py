...
folder_path = '/mnt/6a35bb5c-3c75-400e-a2fa-146fee20967e/home/fcssaleh/Weighted_Belief_Propagation/LDPCMacKay_96_48'
H = np.load(folder_path+'/H_MacKay_96_48.npy')
...
batch_in_epoch = 1000
batches_for_val = np.array([10,20,30,50,150,3500])*300/200
...
with tf.Session() as sess:    
    ...
    for i in range(num_of_batch):
        ...
        if(i%batch_in_epoch == 0):
            ...
            np.save('V2MN49_96_48.npy',BER[1:,:])
            pltf.figure()
            ...
            pltf.grid(True)
            pltf.savefig('V2MN49_96_48_sum_of_BER.png')
            pltf.close()
